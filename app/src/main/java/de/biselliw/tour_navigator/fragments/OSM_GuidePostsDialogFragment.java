 ...
 */
public class OSM_GuidePostsDialogFragment extends SearchResultDialogFragment {
     ...
     */
    public static OSM_GuidePostsDialogFragment newInstance(ControlElements inActivity) {
        OSM_GuidePostsDialogFragment fragment = new OSM_GuidePostsDialogFragment();
        Bundle args = new Bundle();
        args.putString("title", inActivity.getString(R.string.osm_guide_posts_title));
    ...
    /*
    private static SearchResultDialogFragment SearchResultDialogFragment(ControlElements inActivity, String s, Object o) {
        return super.SearchResultDialogFragment(inActivity,"", null);
    }
*/
    @Override
    public void onAttach( @NonNull Context context ) {
        super.onAttach(context);
        SearchOsmGuidePostsFunction searchOsmGuidePosts = new SearchOsmGuidePostsFunction((ControlElements)context, trackListModel);
        prefixWaypointType = searchOsmGuidePosts.getOsmGuidePosts();
        searchFunction = searchOsmGuidePosts;
        searchOsmGuidePosts.assetManager = this.requireContext().getAssets();
    }
     ...
     */
    public OSM_GuidePostsDialogFragment setNotification (Runnable inNotification)
    {
